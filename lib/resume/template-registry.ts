...
export const resumeTemplates: TemplateDefinition[] = [
  ...
  },
  {
    ...
    tags: ["Photo CV", "Portfolio", "Creative", "Project Cards", "Photo supported"],
  ...
  },
  {
    ...
    tags: ["Photo CV", "Tech", "Projects", "Skills Heavy", "Photo supported"],
  ...
  },
  {
    ...
    tags: ["Photo CV", "Executive", "Metrics", "Photo supported"],
  ...
  },
  {
    ...
    name: "Corporate Pro",
    category: "Executive",
    description: "Two-column layout with a navy sidebar, photo, skill bars, and refined corporate hierarchy.",
    bestFor: "Product, business, and leadership applications",
    tags: ["Photo CV", "Photo supported", "Two Column", "Metrics Focused"],
  ...
  },
  {
    ...
    tags: ["Photo CV", "Photo supported", "Two Column", "UAE Hiring"],
  ...
  },
  {
    ...
    tags: ["Leadership", "Photo supported", "Metrics Focused"],
  ...
  },
  {
    ...
    category: "Modern",
    description: "Two-column layout with refined spacing.",
    bestFor: "Experienced professionals",
    tags: ["Two Column", "Photo supported", "Photo CV"],
    features: ["Readable two-column grid", "Elegant sidebar", "Polished spacing"],
    isPremium: false,
    supportsPhoto: true,
