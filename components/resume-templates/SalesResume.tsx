  ...
  return (
    <div className="resume-page px-[14mm] py-[12mm] font-[Arial] text-slate-900">
      ...
      <header className="flex items-end justify-between gap-8 border-b-[3px] border-emerald-700 pb-5">
        ...
        <div className="shrink-0 bg-emerald-50 px-5 py-3 text-center"><p className="text-[25px] font-bold text-emerald-700">92%</p><p className="text-[8px] font-bold uppercase tracking-[0.12em] text-slate-500">Profile Strength</p></div>
      </header>
